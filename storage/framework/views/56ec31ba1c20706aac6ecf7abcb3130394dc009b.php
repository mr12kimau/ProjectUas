<li data-status="personal"
    ...
    <span class="transition duration-150"><?php echo e(__('Personal')); ?></span>
</li>
...
<li data-status="social"
    ...
    <span class="bar-c
            ...
            transition-all duration-150 "></span>
    <span class="transition duration-150"><?php echo e(__('Social')); ?></span>
</li>
...
<li data-status="promotions"
    ...
    <span class="bar-c  bg-warning-500 ring-warning-500  inline-block h-2 w-2 rounded-full ring-opacity-30
            transition-all duration-150 "></span>
    <span class="transition duration-150"><?php echo e(__('Promotions')); ?></span>
</li>
...
<li data-status="business"
    ...
    <span class="bar-c  bg-primary-500 ring-primary-500  inline-block h-2 w-2 rounded-full ring-opacity-30
            transition-all duration-150 "></span>
    <span class="transition duration-150"><?php echo e(__('Business')); ?></span>
</li>

<!-- END: Bottom Filter -->
<?php /**PATH D:\Project\dashcode-laravel-full-source-code\resources\views/components/email/bottomfilter.blade.php ENDPATH**/ ?>