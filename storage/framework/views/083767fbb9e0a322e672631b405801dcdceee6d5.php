<div class="main-menu">
      ...
      <li class="menu-item-has-children">
        ...
        <a href="javascript:void()">
          <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
            ...
            <div class="text-box"> <?php echo e(__('Dashboard')); ?>
          ...
          <li>
            <a href=ecommerce-dashboard.html>
              <div class="flex space-x-2 items-start rtl:space-x-reverse">
                ...
                <span class="leading-[1]">
                  <?php echo e(__('Ecommerce Dashboard')); ?>
          ...
          <li>
            <a href=banking-dashboard.html>
              <div class="flex space-x-2 items-start rtl:space-x-reverse">
                ...
                <span class="leading-[1]">
                  <?php echo e(__('Banking Dashboard')); ?>
      ...
      <li class="menu-item-has-children">
        ...
        <a href="javascript:void()">
          <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
            ...
            <div class="text-box"><?php echo e(__('App')); ?>
      ...
      <li class="
        ...
        <a href="javascript:void()">
          <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
            ...
            <div class="text-box"><?php echo e(__('Pages')); ?>
          ...
          <div class="flex flex-wrap space-x-8 justify-between rtl:space-x-reverse">
            <div>
              ...
              <div class="text-sm font-medium text-slate-900 dark:text-white mb-2 flex space-x-1 items-center">
                <span><?php echo e(__('Authentication')); ?></span>
              </div>
              <!-- single menu item* -->
              ...
              <a href=forget-password-one.html>
                <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                  ...
                  <span
                        class="capitalize text-slate-600 dark:text-slate-300"
                        ><?php echo e(__('Forget Password One')); ?>
              ...
              <a href=forget-password-two.html>
                <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                  ...
                  <span
                        class="capitalize text-slate-600 dark:text-slate-300"
                        ><?php echo e(__('Forget Password Two')); ?>
              ...
              <a href=forget-password-three.html>
                <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                  ...
                  <span
                        class="capitalize text-slate-600 dark:text-slate-300"
                        ><?php echo e(__('Forget Password Three')); ?>
              ...
              <a href=lock-screen-three.html>
                <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                  ...
                  <span
                        class="capitalize text-slate-600 dark:text-slate-300"
                        ><?php echo e(__('Lock Screen Three')); ?>
              ...
              <a href=under-maintanance.html>
                <div class="flex items-center space-x-2 text-[15px] leading-6 rtl:space-x-reverse">
                  ...
                  <span
                        class="capitalize text-slate-600 dark:text-slate-300"
                        >
                    <?php echo e(__('Under Maintanance Page')); ?>
      ...
      <li class="menu-item-has-children">
        ...
        <a href="javascript:void()">
          <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
            ...
            <div class="text-box"><?php echo e(__('Widgets')); ?>
      ...
      <li class="
        ...
        <a href="javascript:void()">
          <div class="flex flex-1 items-center space-x-[6px] rtl:space-x-reverse">
            ...
            <div class="text-box"><?php echo e(__('Extra')); ?>
  ...
  <!-- end top menu -->
<?php /**PATH D:\laragon\www\dashcode-laravel\resources\views/components/topbar-menu.blade.php ENDPATH**/ ?>