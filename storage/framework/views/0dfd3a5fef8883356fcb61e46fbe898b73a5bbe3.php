...
<?php endif; ?>
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-4 gap-7">
            <div class="dasboardCard bg-white dark:bg-slate-800 rounded-md px-5 py-4 flex items-center justify-between bg-center bg-cover bg-no-repeat" style="background-image:url('<?php echo e(asset('/images/ecommerce-wid-bg.png')); ?>')">
                <div class="w-56 ">
                    <h3 class="font-Inter font-normal text-white text-lg">
                        <?php echo e(__('Good evening')); ?>,
                    </h3>
                    ...
                    <p class="font-Intertext-base text-white font-normal">
                        <?php echo e(__('Welcome to dashcode')); ?>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-md px-5 py-4 ">
                <div class="pl-14 relative">
                    ...
                    <p class="font-Intertext-xl text-black dark:text-white font-medium">
                        <?php echo e($data['revenue']['currencySymbol'] .$data['revenue']['total']); ?>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-md px-5 py-4 ">
                <div class="pl-14 relative">
                    ...
                    <h4 class="font-Interfont-normal text-sm text-textColor dark:text-white pb-1">
                        <?php echo app('translator')->get("Growth"); ?>
                    </h4>
                    <p class="font-Intertext-xl text-black dark:text-white font-medium">
            ...
            <div class="mt-8 xl:mt-0 xl:w-4/12 bg-white  dark:bg-slate-800 rounded-md w-full">
                ...
                <div class="overflow-hidden px-6 py-5 grid md:grid-cols-2 gap-4">
                    <div class="statisticsChartCard">
                        <div>
                            <h5 class="text-sm text-slate-600 dark:text-slate-300 mb-[6px]"> <?php echo e(__('Orders')); ?> </h5>
                            <h3 class="text-lg text-slate-900 dark:text-slate-300 font-medium mb-[6px]"><?php echo e($data['lastWeekOrder']['total']); ?></h3>
                            <p class="font-normal text-xs text-slate-600 dark:text-slate-300">
                                <span class="text-red-400">
                                    <?php echo e($data['lastWeekOrder']['preSymbol'].' '.$data['lastWeekOrder']['percentage']); ?>%
                                </span>
                                <?php echo e(__('From last week.')); ?>
                    ...
                    <div class="statisticsChartCard">
                        <div>
                            <h5 class="text-sm text-slate-600 dark:text-slate-300 mb-[6px]"><?php echo e(__('Profit')); ?></h5>
                            <h3 class="text-lg text-slate-900 dark:text-slate-300 font-medium mb-[6px]">
                                <?php echo e($data['lastWeekProfit']['total']); ?>

                            </h3>
                            <p class="font-normal text-xs text-slate-600 dark:text-slate-300">
                                <span class="text-indigo-400">
                                   <?php echo e($data['lastWeekProfit']['preSymbol'].' '.$data['lastWeekProfit']['percentage']); ?>%
                                </span>
                                <?php echo e(__('From last week.')); ?>
                    ...
                    <div class="statisticsChartCard py-4 md:col-span-2 md:flex items-center justify-between">
                        <div>
                            <h5 class="text-sm text-slate-600 dark:text-slate-300 mb-[6px]"><?php echo e($data['lastWeekOverview']['title']); ?></h5>
                            <h3 class="text-lg text-slate-900 dark:text-slate-300 font-medium mb-[6px]"><?php echo e($data['lastWeekOverview']['amount']); ?></h3>
                            <p class="font-normal text-xs text-slate-600 dark:text-slate-300">
                                <span class="text-indigo-400">
                                    <?php echo e($data['lastWeekOverview']['percentage']); ?>%
                                </span>
                                <?php echo e(__('From last Week')); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script type="module">
            ...
            let revenueReportChartConfig = {
                series: [
                    {
                        name: '<?php echo e($data['revenueReport']['revenue']['title']); ?>',
                        data: <?php echo e(Js::from($data['revenueReport']['revenue']['data'])); ?>,
                    },
                    {
                        name: '<?php echo e($data['revenueReport']['netProfit']['title']); ?>',
                        data: <?php echo e(Js::from($data['revenueReport']['netProfit']['data'])); ?>,
                    },
                    {
                        name: '<?php echo e($data['revenueReport']['cashFlow']['title']); ?>',
                        data: <?php echo e(Js::from($data['revenueReport']['cashFlow']['data'])); ?>,
                    },
                ],
                chart: {
                    type: "bar",
                ...
                xaxis: {
                    categories: <?php echo e(Js::from($data['revenueReport']['month'])); ?>,
                    labels: {
                        style: {
                            fontFamily: "Inter",
                        },
            ...
            let revenueChartConfig = {
                ...
                xaxis: {
                    ...
                    categories: <?php echo e(Js::from($data['revenue']['year'])); ?>,
                },
                series: [
                    {
                        data: <?php echo e(Js::from($data['revenue']['data'])); ?>,
                    },
                ],
            };
            ...
            let productSalesChartConfig = {
                ...
                xaxis: {
                    ...
                    categories: <?php echo e(Js::from($data['productSold']['year'])); ?>,
                },
                series: [
                    {
                        data: <?php echo e(Js::from($data['productSold']['quantity'])); ?>,
                    },
                ],
            };
            ...
            let growthChartConfig = {
                ...
                xaxis: {
                    ...
                    categories: <?php echo e(Js::from($data['growth']['year'])); ?>,
                },
                series: [
                    {
                        data: <?php echo e(Js::from($data['growth']['perYearRate'])); ?>,
                    },
                ],
            };
            ...
            let lastWeekOrderChartConfig = {
                series: [
                    {
                        name: <?php echo e(Js::from($data['lastWeekOrder']['name'])); ?>,
                        data: <?php echo e(Js::from($data['lastWeekOrder']['data'])); ?>,
                    },
                ],
                chart: {
                    type: "bar",
            ...
            let lastWeekProfitChartConfig = {
                series: [
                    {
                        name: <?php echo e(Js::from($data['lastWeekProfit']['name'])); ?>,
                        data: <?php echo e(Js::from($data['lastWeekProfit']['data'])); ?>,
                    },
                ],
                chart: {
                    height: 50,
            ...
            let lastWeekOverviewChartConfig = {
                series: <?php echo e(Js::from($data['lastWeekOverview']['data'])); ?>,
                chart: {
                    type: 'donut',
                    width: "240px"
                },
                labels: <?php echo e(Js::from($data['lastWeekOverview']['labels'])); ?>,
                dataLabels: {
                    enabled: false,
                },
...
<?php endif; ?>
<?php /**PATH D:\Project\dashcode-laravel-full-source-code\resources\views/dashboards/ecommerce.blade.php ENDPATH**/ ?>