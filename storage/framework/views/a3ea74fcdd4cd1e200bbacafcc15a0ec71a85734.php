...
<?php $component->withAttributes([]); ?>
    <div class="bg-slate-100 dark:bg-slate-900">
        <div class="min-h-screen flex flex-col justify-center items-center text-center py-20">
            <img src="<?php echo e(asset('/images/404.svg')); ?>" alt="image" />
            <div class="max-w-[546px] mx-auto w-full mt-12">
                <h4 class="text-slate-900 mb-4 font-Inter text-3xl leading-9 font-semibold"><?php echo e(__('Not Found.')); ?></h4>
...
<?php endif; ?>
<?php /**PATH D:\Project\dashcode-laravel-full-source-code\resources\views/errors/404.blade.php ENDPATH**/ ?>