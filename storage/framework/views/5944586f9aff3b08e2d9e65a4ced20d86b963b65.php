...
<?php endif; ?>
          <button class="btn inline-flex justify-center btn-dark rounded-[25px]">
                ...
                <span><a href="<?php echo e(route('product.create')); ?>">Tambah</a></span> </span>
            </button>
        </div>
                      ...
                      <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700" id="data-table">
                        ...
                        <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                            ...
                            <tr>
                              ...
                              <td class="table-td "><?php echo e($item['category']); ?></td>
                              <td class="table-td ">
                                <div>
                                  <?php echo e($item['suhu']); ?>
                                  ...
                                  <div class="relative">
                                    <div class="dropdown relative">
                                      ...
                                      <ul class=" dropdown-menu min-w-[120px] absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700
                                        ...
                                        <li>
                                          <a
                                            href="<?php echo e(route('product.edit', $item->id)); ?>"
                                            class="text-slate-600 dark:text-white block font-Inter font-normal px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600
                                              dark:hover:text-white">
                                            Edit</a>
                                        </li>
                                        ...
                                        <form id="delete-form-<?php echo e($item->id); ?>" action="<?php echo e(route('product.destroy', $item->id)); ?>" method="POST" style="display: none;">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Project\Dashboard\resources\views/products/index.blade.php ENDPATH**/ ?>