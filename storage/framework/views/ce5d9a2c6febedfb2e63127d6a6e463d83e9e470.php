...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('users.store')); ?>"  class="max-w-4xl m-auto">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid sm:grid-cols-1 gap-x-8 gap-y-4">
                    ...
                    <div class="input-area">
                        ...
                        <input name="name" type="text" id="name" class="form-control"
                               placeholder="<?php echo e(__('Enter your name')); ?>" value="<?php echo e(old('name')); ?>" required>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                    ...
                    <div class="input-area">
                        ...
                        <input name="password" type="password" id="password" class="form-control" placeholder="<?php echo e(__('Enter Password')); ?>" >
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('email'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\dashcode-laravel\resources\views/users/create.blade.php ENDPATH**/ ?>