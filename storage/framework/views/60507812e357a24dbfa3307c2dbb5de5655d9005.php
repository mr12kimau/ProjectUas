...
<footer id="footer">
    <div class="site-footer px-6 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-300 py-4 ltr:ml-[248px] rtl:mr-[248px]">
        ...
        <div class="text-center ltr:md:text-start rtl:md:text-right text-sm">
            <?php echo e(__('COPYRIGHT')); ?> © <script>  document.write(new Date().getFullYear())</script> <?php echo e(__('DashCode, All rights Reserved')); ?>

        </div>
        <div class="ltr:md:text-right rtl:md:text-end text-center text-sm">
            <?php echo e(__('Design & Develop by')); ?>
...
<?php /**PATH D:\Project\dashcode-laravel-full-source-code\resources\views/components/dashboard-footer.blade.php ENDPATH**/ ?>