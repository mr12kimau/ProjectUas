<form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
    ...
    <div class="fromGroup">
        <label for="email" class="block capitalize form-label"><?php echo e(__('Email')); ?></label>
        <div class="relative ">
...
unset($__errorArgs, $__bag); ?>"
                placeholder="<?php echo e(__('Type your email')); ?>" autofocus
...
<?php endif; ?>
    ...
    <div class="fromGroup">
        <label for="password" class="block capitalize form-label"><?php echo e(__('Password')); ?></label>
        <div class="relative ">
            <input type="password" name="password" class="form-control py-2 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !border !border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Password')); ?>" id="password" autocomplete="current-password">
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
    ...
    <div class="flex justify-between">
        <div class="checkbox-area">
            <label class="inline-flex items-center cursor-pointer" for="remember_me">
                ...
                <span class="text-slate-500 dark:text-slate-400 text-sm leading-6"><?php echo e(__('Keep me signed in')); ?></span>
            </label>
        </div>
        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-slate-800 dark:text-slate-400 leading-6 font-medium">
...
<?php /**PATH D:\Project\dashcode-laravel-full-source-code\resources\views/components/login-form.blade.php ENDPATH**/ ?>