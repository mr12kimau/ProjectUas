...
<div data-simplebar class="h-full">
    <div class=" p-6">
        <h4 class="text-xl text-slate-900 font-medium mb-8"><?php echo e(__('About')); ?></h4>
        ...
        <div class="text-center">
            ...
            <h6 class="text-xs text-slate-600 dark:text-slate-300 font-normal"><?php echo e(__('Frontend Developer')); ?></h6>
        </div>
        <ul class="list-item mt-5 space-y-4 border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
            ...
            <li class="flex justify-between text-sm text-slate-600 dark:text-slate-300 leading-[1]">
                <div class="flex space-x-2 items-start rtl:space-x-reverse">
                    ...
                    <span><?php echo e(__('Members since')); ?></span>
                </div>
        ...
        <h4 class="py-4 text-sm text-secondary-500 dark:text-slate-300 font-normal"><?php echo e(__('Shared Documents')); ?></h4>
...
<!-- END: Info Area -->
<?php /**PATH D:\Project\dashcode-laravel-full-source-code\resources\views/components/chat/info.blade.php ENDPATH**/ ?>