                ...
                <div class="md:flex items-end md:space-x-6 rtl:space-x-reverse">
                    <div class="flex-none">
                        <div class="md:h-[186px] md:w-[186px] h-[140px] w-[140px] md:ml-0 md:mr-0 ml-auto mr-auto md:mb-0 mb-4 rounded-full ring-4
                            ...
                            <img src="<?php echo e(auth()->user()->getFirstMediaUrl('profile-image') ?:
                        ...
                        <ul class="list space-y-8">
                            <li class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <div class="flex-1">
                                    ...
                                    <a href="mailto:<?php echo e(auth()->user()->email ?: 'N/A'); ?>" class="text-base text-slate-600 dark:text-slate-50">
                                        <?php echo e(auth()->user()->email ?: 'N/A'); ?>
                            ...
                            <li class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <div class="flex-1">
                                    ...
                                    <a href="<?php echo e(auth()->user()->phone); ?>" class="text-base text-slate-600 dark:text-slate-50">
                                        <?php echo e(auth()->user()->phone ?: 'N/A'); ?>
...
<?php endif; ?>
                            <br />
                        <?php endif; ?>
                        <?php if(auth()->user()->getPendingEmail()): ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.alert','data' => ['message' => __(
                                'Please check your email to verify your new email address. You cant use your new email to login until you verify it.',
                            ),'type' => 'danger']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['message' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__(
                                'Please check your email to verify your new email address. You cant use your new email to login until you verify it.',
                            )),'type' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('danger')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                        ...
                        <form action="<?php echo e(route('profiles.update', auth()->user())); ?>" method="POST"
...
<?php endif; ?>
                                ...
                                <div class="input-area">
                                    ...
                                    <input name="phone" type="tel" id="phone" class="form-control"
                                        placeholder="<?php echo e(__('Phone')); ?>" value="<?php echo e(auth()->user()->phone); ?>">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                ...
                                <div class="input-area">
                                    <label for="postcode" class="form-label">
                                        <?php echo e(__('Post Code')); ?>

                                    </label>
                                    <input name="post_code" type="text" id="post" class="form-control"
                                        placeholder="<?php echo e(__('Post Code')); ?>" value="<?php echo e(auth()->user()->post_code); ?>">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('post_code'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('post_code')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                                ...
                                <div class="input-area">
                                    <label for="state" class="form-label">
                                        <?php echo e(__('State / City')); ?>

                                    </label>
                                    <input name="city" type="text" id="state" class="form-control"
                                        placeholder="<?php echo e(__('State / City')); ?>" value="<?php echo e(auth()->user()->city); ?>">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                ...
                                <div class="input-area">
                                    ...
                                    <input name="country" type="text" id="country" class="form-control"
                                        placeholder="<?php echo e(__('Country')); ?>" value="<?php echo e(auth()->user()->country); ?>">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                ...
                                <div class="input-area">
                                    ...
                                    p-[0.565rem] pl-2">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('photo'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\dashcode-laravel\resources\views/profiles/index.blade.php ENDPATH**/ ?>