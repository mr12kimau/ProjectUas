...
<ul class="flex">
    ...
    <li class="flex-1">
        <a href="<?php echo e(route('social.login', 'linkedin')); ?>"
...
<?php /**PATH D:\Project\dashcode-laravel-full-source-code\resources\views/components/social-login.blade.php ENDPATH**/ ?>