        ...
        <div class="card xl:col-span-2">
            <div class="card-body flex flex-col p-6">
                ...
                <div class="card-text h-full">
                    ...
                    <form class="space-y-4" action="<?php echo e(route('employee.store')); ?>" method="POST" id="multipleValidation">
...
<?php endif; ?>
<?php /**PATH D:\Project\Dashboard\resources\views/employees/tambah.blade.php ENDPATH**/ ?>