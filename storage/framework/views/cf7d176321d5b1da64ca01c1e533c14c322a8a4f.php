...
<?php endif; ?>
        ...
        <div class="text-center 2xl:mb-10 mb-4">
            <h4 class="font-medium"> <?php echo e(__('Sign in')); ?></h4>
            <div class="text-slate-500 text-base">
                <?php echo e(__('Sign in to your account to start using Dashcode')); ?>
...
<?php endif; ?>
        ...
        <div class="md:max-w-[345px] mx-auto font-normal text-slate-500 dark:text-slate-400 mt-12 uppercase text-sm">
            ...
            <a href="<?php echo e(route('register')); ?>" class="text-slate-900 dark:text-white font-medium hover:underline">
...
<?php endif; ?><?php /**PATH D:\Project\dashcode-laravel-full-source-code\resources\views/auth/login.blade.php ENDPATH**/ ?>