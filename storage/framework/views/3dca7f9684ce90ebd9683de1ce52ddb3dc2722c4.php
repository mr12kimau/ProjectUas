        ...
        <div class="card">
            <header class=" card-header noborder">
                <div class="justify-end flex gap-3 items-center flex-wrap">
                    ...
                    <a class="btn inline-flex justify-center btn-dark rounded-[25px] items-center !p-2 !px-3" href="<?php echo e(route('permissions.create')); ?>">
                    ...
                    <a class="btn inline-flex justify-center btn-dark rounded-[25px] items-center !p-2.5" href="<?php echo e(route('permissions.index')); ?>">
                        <iconify-icon icon="mdi:refresh" class="text-xl "></iconify-icon>
                    </a>
                </div>
                <div class="justify-center flex flex-wrap sm:flex items-center lg:justify-end gap-3">
                    <div class="relative w-full sm:w-auto flex items-center">
                        <form id="searchForm" method="get" action="<?php echo e(route('permissions.index')); ?>">
                ...
                <div class="overflow-x-auto -mx-6">
                    <div class="inline-block min-w-full align-middle">
                        <div class="overflow-hidden ">
                            <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                ...
                                <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                    ...
                                    <tr class="border border-slate-100 dark:border-slate-900 relative">
                                        <td class="table-td sticky left-0"># <?php echo e($permission->id); ?></td>
                                        <td class="table-td">
                                            <span><?php echo e($permission->name); ?></span>
                                        </td>
                                        <td class="table-td"><?php echo e($permission->created_at->toFormattedDateString()); ?></td>
                                        <td class="table-td">
                                            <div class="action-btns space-x-2 flex">
                                                
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission update')): ?>
                                                <a class="action-btn" href="<?php echo e(route('permissions.edit', ['permission' => $permission])); ?>">
                                                    <iconify-icon icon="uil:edit"></iconify-icon>
                                                </a>
                                                <?php endif; ?>
                                                
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission delete')): ?>
                                                <form id="deleteForm<?php echo e($permission->id); ?>" method="POST" action="<?php echo e(route('permissions.destroy', $permission)); ?>" class="cursor-pointer">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <a class="action-btn" onclick="sweetAlertDelete(event, 'deleteForm<?php echo e($permission->id); ?>')" type="submit">
                            ...
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-footer','data' => ['perPageRouteName' => 'permissions.index','data' => $permissions]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['per-page-route-name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('permissions.index'),'data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($permissions)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?><?php /**PATH D:\laragon\www\dashcode-laravel\resources\views/permissions/index.blade.php ENDPATH**/ ?>