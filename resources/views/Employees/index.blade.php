    ...
    <div class="space-y-8">
        <div class="flex justify-between items-center">
          ...
          <button class="btn inline-flex justify-center btn-dark rounded-[25px] ">
                ...
                <span><a href="{{ route('employee.create') }}">Tambah</a></span> </span>
            </button>
        </div>
                      ...
                      <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700" id="data-table">
                        ...
                        <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                            ...
                            <tr>
                              ...
                              <td class="table-td ">{{ $item['jabatan'] }}</td>
                              <td class="table-td ">
                                <div>
                                  {{ $item['phone'] }}
                                </div>
                                  ...
                                  <div class="relative">
                                    <div class="dropdown relative">
                                      ...
                                      <ul class=" dropdown-menu min-w-[120px] absolute text-sm text-slate-700 dark:text-white hidden bg-white dark:bg-slate-700
                                        ...
                                        <form id="delete-form-{{ $item->id }}" action="{{ route('employee.destroy', $item->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        </li>
